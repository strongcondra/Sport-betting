<?php $__env->startSection('title', 'Mail To Subscriber'); ?>

<?php $__env->startSection('content'); ?>
    <div class="m-0 m-md-4 my-4 m-md-0">
        <form method="post" action="<?php echo e(route('admin.subscriber.mail')); ?>">
            <?php echo csrf_field(); ?>
            <div class="col-sm-12">
                <div class="card card-primary shadow">
                    <div class="card-body">
                        <h3><?php echo app('translator')->get("Send Email To Subscribers"); ?></h3>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group ">
                            ...
                            <textarea class="form-control" name="message" id="summernote" rows="15"><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\c\resources\views/admin/subscriber/send_email.blade.php ENDPATH**/ ?>